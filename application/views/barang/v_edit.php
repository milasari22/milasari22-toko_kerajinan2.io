    ...
    <div class="card card-primary">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <input type="number" min="0" name="berat" class="form-control" placeholder="Berat Barang Dalam Satuan Gram" value="<?= $barang->berat  ?>">
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            <img src="<?= base_url('assets/gambar/'. $barang->gambar) ?>" width="400px" id="gambar_load" alt="">
                        </div>
                    </div>
                </div>
